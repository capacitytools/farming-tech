      ...
      <header className="sticky top-0 z-40 bg-white/80 dark:bg-forest-900/80 backdrop-blur-xl border-b border-white/40 dark:border-forest-700/40">
        <div className="mx-auto max-w-md flex items-center justify-between px-4 py-3">
          ...
          <div className="flex items-center gap-1">
            ...
            <button aria-label="Open menu" onClick={() => setOpen(true)} className="w-10 h-10 flex items-center justify-center rounded-full active:bg-forest-100 dark:active:bg-forest-800">
                ...
                <div className="pt-2 border-t border-forest-100 dark:border-forest-800">
                  ...
                  <div className="flex gap-2 px-1">
                    {[
                      ...
                      <a key={i} href={s.href} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-forest-50 dark:bg-forest-800 flex items-center justify-center">
